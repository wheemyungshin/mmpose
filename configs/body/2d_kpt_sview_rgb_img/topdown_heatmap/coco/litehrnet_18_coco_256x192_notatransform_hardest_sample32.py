...
train_pipeline = [
    ...
    dict(type='TopDownRandomShiftBboxCenter', shift_factor=0.5, prob=0.4),#more shift for more truncated boxes
    ...
    dict(
        ...
        scale_factor=0.4, rot_prob=0.75),#more scaling for more truncated boxes
